    ...
    execute: function () {
      ...
      _export("batleManage", batleManage = (_dec = ccclass('batleManage'), _dec(_class = (_temp = class batleManage extends Component {
        ...
        generateTileMap() {
          ...
          var manage = tileMap.addComponent(_crd && tileManage === void 0 ? (_reportPossibleCrUseOftileManage({
            error: Error()
        ...
        generatePlayer() {
          ...
          var playerManage = player.addComponent(_crd && PlayerManage === void 0 ? (_reportPossibleCrUseOfPlayerManage({
            error: Error()
        ...
        adaptPosition() {
          ...
          var disX = mapRowCount / 2 * (_crd && TILE_WIDTH === void 0 ? (_reportPossibleCrUseOfTILE_WIDTH({
            error: Error()
          }), TILE_WIDTH) : TILE_WIDTH);
          var disY = mapColumnCount / 2 * (_crd && TILE_HEIGHT === void 0 ? (_reportPossibleCrUseOfTILE_HEIGHT({
            error: Error()
